...
export class EventoService {
    ...
    // http://localhost:8080/api/paneldecontrol/v1/getcantidadeventossaeporzonal
    getCantidadEventosSaePorZonal(): Observable<any> {
        return this.http.get<Eventos[]>(`${this.configService.baseUrl}/api/paneldecontrol/v1/getcantidadeventossaeporzonal`).pipe(
            map((response) => {
                return response;
            })
        );
    ...
    // http://localhost:8080/api/paneldecontrol/v1/getcanteventsaeorganizadomes

    getcanteventsaeorganizadomes(): Observable<any> {
        return this.http.get<Eventos[]>(`${this.configService.baseUrl}/api/paneldecontrol/v1/getcanteventsaeorganizadomes`).pipe(
            map((response) => {
                return response;
            })
        );
